...
type HomeQueryQuery = { readonly martySkateboard: Maybe<{ readonly childImageSharp: Maybe<MediumImageFragment> }>, readonly pixelBanner: Maybe<{ readonly childImageSharp: Maybe<MediumImageFragment> }> };
