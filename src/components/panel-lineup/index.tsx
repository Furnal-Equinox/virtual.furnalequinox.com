...
const PanelLineup: React.FC = () => {
  const data = useStaticQuery<GatsbyTypes.PanelLineupQueryQuery>(panelLineupQuery)
...
export default PanelLineup

export const panelLineupQuery = graphql`
  query PanelLineupQuery {
